...
ActiveRecord::Schema[8.1].define(version: 2026_05_30_232016) do
  ...
  create_table "users", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "email"
    t.integer "in_progress_reading_count", default: 0, null: false
    t.string "kobo_handle"
    t.string "name"
    t.integer "role", default: 0, null: false
    t.datetime "updated_at", null: false
    t.string "username", null: false
    t.index ["kobo_handle"], name: "index_users_on_kobo_handle", unique: true
